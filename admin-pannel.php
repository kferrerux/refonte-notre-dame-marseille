                ...
                <div class="w-100 card p-2 m-3 d-flex align-items-center justify-content-center">
                    ...
                    <div class="d-flex flex-column align-items-center justify-content-centecard-body">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="update-product.php" class="fw-bold btn btn-warning rounded m-2 p-2">Modifier ce produit</a>
                            <a href="delete-product.php" class="fw-bold btn btn-danger rounded p-2">Supprimer ce produit</a>
                        </div>
