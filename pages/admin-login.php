<?php
ob_start(); // MISE EN MEMOIRE TAMPON DU CONTENU
...
ob_end_flush(); // ON SUPPRIME LE CACHE
?>
<main>
    ...
    <section id="admin-pannel" class="mt-5 d-flex flex-wrap justify-content-center align-items-center m-0 p-5 text-black">
        <div class="mt-5 d-flex flex-column justify-content-center align-items-center">
            ...
            <form action="admin-login.php" method="POST">
                ...
                <input type="submit" value="Connexion" class="rounded-0 my-3 w-100 mt-3 fw-bold btn btn-success rounded p-3">
